  ...
  public: {
    Tables: {
      ...
      ai_learning_data: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_learning_data_ticket_id_fkey"
            columns: ["ticket_id"]
            isOneToOne: false
      ...
      entity_skills: {
        ...
        Relationships: [
          {
            foreignKeyName: "entity_skills_skill_id_fkey"
            columns: ["skill_id"]
            isOneToOne: false
      ...
      team_members: {
        Row: {
          ...
          team_id: string
          team_member_role: Database["public"]["Enums"]["team_member_role"]
          user_id: string
        }
        Insert: {
          deleted_at?: string | null
      ...
      ticket_categories: {
        ...
        Relationships: [
          {
            foreignKeyName: "ticket_categories_ticket_id_fkey"
            columns: ["ticket_id"]
            isOneToOne: false
            referencedRelation: "tickets"
            referencedColumns: ["id"]
      ...
      ticket_watchers: {
        Row: {
          ...
          ticket_id: string
          watcher_id: string
          watcher_type: Database["public"]["Enums"]["watcher_type"]
        }
        Insert: {
          added_at?: string
          added_by: string
